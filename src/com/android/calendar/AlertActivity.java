...
public class AlertActivity extends Activity {
    ...
    public static long SNOOZE_DELAY = 5 * 60 * 1000L;
    ...
    protected void onCreate(Bundle icicle) {
        ...
        //add for get the default snooze time begin
    	SharedPreferences prefs = CalendarPreferenceActivity.getSharedPreferences(AlertActivity.this);
    	final String dur =
    			prefs.getString("preferences_default_reminder",
                        "5");
    	int duration = Integer.parseInt(dur);
    	SNOOZE_DELAY = duration * 60 * 1000L;
    	///add for get the default snooze time begin
    }
    ...
    protected void onStop() {
        super.onStop();
//        AlertService.getInstance().updateAlertNotification(this);
