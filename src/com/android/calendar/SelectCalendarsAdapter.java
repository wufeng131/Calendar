...
public class SelectCalendarsAdapter extends CursorTreeAdapter implements View.OnClickListener {
    ...
    protected void bindGroupView(View view, Context context, Cursor cursor, boolean isExpanded) {
        ...
        if (account.equals("Local Calendar") && accountType.equals("Local Calendar")) {
            account = context.getResources().getString(R.string.local_calendar);
            accountType = context.getResources().getString(R.string.local_calendar);
        }

        setText(view, R.id.account, account);
        // setText(view, R.id.account_type,
        // getLabelForType(accountType).toString());
        setText(view, R.id.account_type, accountType);
    }
