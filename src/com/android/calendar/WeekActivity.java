...
//        mProgressBar = (ProgressBar) findViewById(R.id.progress_circular);
        ...
        weekLeftBtn = (Button) findViewById(R.id.week_left);
        weekLeftBtn.setOnClickListener(new OnClickListener() {
        ...
        weekRightBtn = (Button) findViewById(R.id.week_right);
        weekRightBtn.setOnClickListener(new OnClickListener() {
