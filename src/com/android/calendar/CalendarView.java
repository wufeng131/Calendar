...
public class CalendarView extends View
    ...
    private void remeasure(int width, int height) {
        ...
        try {
			...
			e.printStackTrace();
			Log.v("CalenaderView","Exception "+e);
			/* start: fix 23331 --> we should catch OutOfMemoryError . added by spreadsoft 20120810 */
		}catch(Error e){
			e.printStackTrace();
			Log.v("CalenaderView","Error "+e);
		}
        /* end: fix 23331 --> we should catch OutOfMemoryError . added by spreadsoft 20120810 */
...
//        performLongClick();
    ...
    public boolean switchCalView(int deltaX) {
    	boolean switchForward = initNextView(deltaX);
    	CalendarView view = mParentActivity.getNextView();
        mTitleTextView.setText(view.mDateRange);
    	mParentActivity.switchViews(switchForward, 0, mViewWidth);
    	return true;
    }
    ...
    private static int getEventAccessLevel(Context context, Event e) {
        ...
        String where = String.format(Locale.US,CALENDARS_WHERE, calId);
